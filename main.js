...
var Main = function() { };
Main.main = function() {
	console.log("src/Main.hx:23:",JSON.stringify({ a : Math.floor(1001 * Math.random()), atp1 : [{ f : Random.string(100), tp2 : { y : Random.string(100)}, x : Math.floor(1001 * Math.random())}], b : Random.string(100), c : Math.floor(1001 * Math.random()), d : Math.random() < 0.5, e : [Math.floor(101 * Math.random())], f : { g : [Math.random() < 0.5], y : [Random.string(100)]}, tp1 : { f : Random.string(100), tp2 : { y : Random.string(100)}, x : Math.floor(1001 * Math.random())}},null," "));
};
var Random = function() { };
